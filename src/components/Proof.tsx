  ...
  return (
    <section id="results" className="py-12 md:py-24 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          {caseStudies.map((study, index) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] md:text-xs text-brand-silver flex items-center gap-1 mt-1 font-medium">
        ...
        >
          <h3 className="text-3xl sm:text-4xl md:text-6xl font-black uppercase italic leading-none flex flex-col items-center gap-2">
            <span className="text-brand-silver text-sm sm:text-base md:text-lg font-bold tracking-widest">AND</span>
