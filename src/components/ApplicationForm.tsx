            ...
            <div className="p-12 md:p-16">
              <div className="mb-12">
                <div className="flex justify-between items-center mb-6">
                  <span className="technical-label text-brand-red">Step {step} of {totalSteps}</span>
                    ...
                    {[...Array(totalSteps)].map((_, i) => (
                      <div 
                        ...
                        className={cn(
                          ...
                          i + 1 <= step ? "bg-brand-red" : "bg-white/10"
                        )} 
                      />
                    ))}
                  </div>
              ...
              <div className="min-h-[300px]">
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <label className="block">
                        ...
                        <input type="text" className="w-full bg-white/5 border border-white/10 p-4 rounded-2xl focus:border-brand-red outline-none transition-all text-white font-mono text-sm" placeholder="John Doe" />
                      </label>
                      <label className="block">
                        <span className="technical-label block mb-2">Instagram Handle</span>
                        <input type="text" className="w-full bg-white/5 border border-white/10 p-4 rounded-2xl focus:border-brand-red outline-none transition-all text-white font-mono text-sm" placeholder="@yourhandle" />
                      </label>
                    </div>
                  </motion.div>
                )}
                  ...
                  >
                    ...
                    <div className="grid gap-3">
                      {['Low Prices', 'No Consistent Leads', 'Trading Time for Money', 'Lack of Systems'].map((option) => (
                        <button key={option} className="w-full text-left p-6 glass-card border-white/10 hover:border-brand-red bg-white/5 transition-all flex justify-between items-center group">
                          <span className="font-bold text-sm uppercase tracking-tight">{option}</span>
                          <CheckCircle2 size={18} className="text-brand-red opacity-0 group-hover:opacity-100 transition-opacity" />
                        </button>
                      ))}
                    </div>
                  </motion.div>
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    <div className="p-8 glass-card border-brand-red/20 bg-brand-red/5">
                      <div className="technical-label text-brand-red mb-4 opacity-100">System Ready</div>
              ...
              <button 
                onClick={handleNext}
                className="w-full mt-8 md:mt-12 bg-brand-red text-white font-black uppercase italic py-4 md:py-6 text-sm md:text-base rounded-full flex items-center justify-center gap-2 hover:bg-red-500 active:scale-[0.98] transition-all shadow-[0_0_30px_rgba(220,38,38,0.4)] btn-sheen"
              >
