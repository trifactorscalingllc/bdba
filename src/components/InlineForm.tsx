    ...
    return (
      <div className="w-full mx-auto glass-card bg-black/40 backdrop-blur-xl overflow-hidden relative z-10 shadow-[0_0_100px_rgba(0,0,0,1)]">
        <div className="p-6 sm:p-10 md:p-16 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-white/60 text-xs sm:text-sm md:text-base">We'll be in touch soon. Stay tuned.</p>
        </div>
      </div>
    );
  }
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 4 && (
              <motion.div key="s4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4 sm:space-y-5 text-left">
                ...
                <div>
                  <label htmlFor="inline-fit-textarea" className="text-white/60 text-[10px] sm:text-xs mb-2 block">What makes you a solid fit to run these systems?<span className="text-brand-red">*</span></label>
                  <textarea
                    id="inline-fit-textarea"
                    value={situationText}
